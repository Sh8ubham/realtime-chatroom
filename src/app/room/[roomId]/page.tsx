...
const copyLink = () =>{
    ...
    setTimeout(() =>setCopyStatus("COPY"),
    2000)
}

    return (
  <main className="flex flex-col h-screen max-h-screen overflow-hidden">
    <header className="border-b border-zinc-800 flex items-center justify-between bg-zinc-900/30 p-4">
   ...
   <div className="p-4 border-t border-zinc-800 bg-zinc-900/30">
      <div className="flex gap-4">
        <div className="flex-1 relative">
            ...
            autoFocus type="text" className="w-full bg-zinc-800 border border-zinc-700 rounded py-3 px-4 pl-8 focus:border-zinc-600 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-500 text-sm"/>
        </div>
